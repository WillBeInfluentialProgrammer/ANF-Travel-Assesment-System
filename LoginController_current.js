...
(function () {
    ...
    app.controller('LoginController',
        function($state, $scope, $rootScope, $q, $stateParams, userService, $mdToast, AuthService,
            ...
            // Enable login fields using Angular's jqLite or timeout to ensure DOM is ready
            $interval(function() {
                var userLogin = document.getElementById('user_login');
                var userPass = document.getElementById('user_pass');
                if (userLogin) userLogin.disabled = false;
                if (userPass) userPass.disabled = false;
            }, 100, 5); // Try 5 times with 100ms interval
